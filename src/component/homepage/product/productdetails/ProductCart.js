                ...
                <div className="cart_container">
                    ...
                    <div className="right_cart">
                        ...
                        <div className='products_item'>
                            <p className='product_id'>{inddata.teaid}</p>
                            <p className='product_name'>{inddata.teatitle.teashortTitle}</p>
                            <p className='product_subname'>{inddata.teatitle.tealongTitle}</p>
                        </div>
                    </div>
                </div>}
            </div>
